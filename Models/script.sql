USE [master]
GO
/****** Object:  Database [Demo_2]    Script Date: 16-Apr-25 4:39:45 PM ******/
CREATE DATABASE [Demo_2]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'Demo_2', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Demo_2.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'Demo_2_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL16.SQLEXPRESS\MSSQL\DATA\Demo_2_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
 WITH CATALOG_COLLATION = DATABASE_DEFAULT, LEDGER = OFF
GO
ALTER DATABASE [Demo_2] SET COMPATIBILITY_LEVEL = 150
GO
IF (1 = FULLTEXTSERVICEPROPERTY('IsFullTextInstalled'))
begin
EXEC [Demo_2].[dbo].[sp_fulltext_database] @action = 'enable'
end
GO
ALTER DATABASE [Demo_2] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [Demo_2] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [Demo_2] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [Demo_2] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [Demo_2] SET ARITHABORT OFF 
GO
ALTER DATABASE [Demo_2] SET AUTO_CLOSE OFF 
GO
ALTER DATABASE [Demo_2] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [Demo_2] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [Demo_2] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [Demo_2] SET CURSOR_DEFAULT  GLOBAL 
GO
ALTER DATABASE [Demo_2] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [Demo_2] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [Demo_2] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [Demo_2] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [Demo_2] SET  ENABLE_BROKER 
GO
ALTER DATABASE [Demo_2] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [Demo_2] SET DATE_CORRELATION_OPTIMIZATION OFF 
GO
ALTER DATABASE [Demo_2] SET TRUSTWORTHY OFF 
GO
ALTER DATABASE [Demo_2] SET ALLOW_SNAPSHOT_ISOLATION OFF 
GO
ALTER DATABASE [Demo_2] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [Demo_2] SET READ_COMMITTED_SNAPSHOT OFF 
GO
ALTER DATABASE [Demo_2] SET HONOR_BROKER_PRIORITY OFF 
GO
ALTER DATABASE [Demo_2] SET RECOVERY FULL 
GO
ALTER DATABASE [Demo_2] SET  MULTI_USER 
GO
ALTER DATABASE [Demo_2] SET PAGE_VERIFY CHECKSUM  
GO
ALTER DATABASE [Demo_2] SET DB_CHAINING OFF 
GO
ALTER DATABASE [Demo_2] SET FILESTREAM( NON_TRANSACTED_ACCESS = OFF ) 
GO
ALTER DATABASE [Demo_2] SET TARGET_RECOVERY_TIME = 60 SECONDS 
GO
ALTER DATABASE [Demo_2] SET DELAYED_DURABILITY = DISABLED 
GO
ALTER DATABASE [Demo_2] SET ACCELERATED_DATABASE_RECOVERY = OFF  
GO
ALTER DATABASE [Demo_2] SET QUERY_STORE = OFF
GO
USE [Demo_2]
GO
/****** Object:  Table [dbo].[Discount]    Script Date: 16-Apr-25 4:39:45 PM ******/
SET ANSI_NULLS ON
GO
...
GO
/****** Object:  Table [dbo].[OrderItems]    Script Date: 16-Apr-25 4:39:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Orders]    Script Date: 16-Apr-25 4:39:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductImages]    Script Date: 16-Apr-25 4:39:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductPrices]    Script Date: 16-Apr-25 4:39:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Products]    Script Date: 16-Apr-25 4:39:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ProductSales]    Script Date: 16-Apr-25 4:39:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Roles]    Script Date: 16-Apr-25 4:39:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[Users]    Script Date: 16-Apr-25 4:39:45 PM ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
INSERT [dbo].[Products] ([ProductID], [Name], [Type], [Description], [ImageURL], [IsDelete]) VALUES (12, N'Com rang', N'Cơm', N'no', N'https://product.hstatic.net/1000141988/product/banh_snack_cua_xanh_kinh_do_29_g__i0015950__293edc9f144247c19f4032e930003b98.png', 0)
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Discount__A25C5AA70563B39F]    Script Date: 16-Apr-25 4:39:46 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Roles__8A2B6160AAF4B75F]    Script Date: 16-Apr-25 4:39:46 PM ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [UQ__Users__A9D1053499B25534]    Script Date: 16-Apr-25 4:39:46 PM ******/
...
USE [master]
GO
ALTER DATABASE [Demo_2] SET  READ_WRITE 
GO
